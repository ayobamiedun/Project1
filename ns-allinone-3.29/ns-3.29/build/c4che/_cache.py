...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fstack-protector', '-g', '-fwrapv', '-O2']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fstack-protector', '-g', '-fwrapv', '-O2']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fstack-protector', '-g', '-fwrapv', '-O2']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fstack-protector', '-g', '-fwrapv', '-O2', '-fvisibility=hidden', '-Wno-array-bounds']
...
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_SIGNAL_H': '', 'HAVE_SYS_TYPES_H': '', 'PYTHONDIR': '', 'INT64X64_USE_128': '', 'HAVE_DIRENT_H': '', 'HAVE_STDINT_H': '', 'HAVE_LIBXML2': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_PYEXT': '', 'HAVE_SYS_STAT_H': '', 'HAVE_PACKET_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_STDLIB_H': '', 'HAVE_PTHREAD_H': '', 'HAVE_PYTHON_H': '', 'HAVE___UINT128_T': '', 'HAVE_PYEMBED': '', 'PYTHONARCHDIR': '', 'HAVE_GETENV': '', 'HAVE_RT': '', 'HAVE_IF_TUN_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_UINT128_T': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['matrix-topology', 'routing', 'tcp', 'traffic-control', 'socket', 'stats', 'error-model', 'realtime', 'ipv6', 'tutorial', 'energy', 'udp', 'naming', 'udp-client-server', 'wireless']
...
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['pthread', 'dl', 'util', 'm', 'python2.7', 'pthread', 'dl', 'util', 'm', 'python2.7']
LIB_PYEXT = ['pthread', 'dl', 'util', 'm', 'python2.7', 'pthread', 'dl', 'util', 'm', 'python2.7']
LIB_RT = ['rt']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/home/ayobami/Project1/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/home/ayobami/Project1/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.9', '/home/ayobami/Project1/ns-allinone-3.29/ns-3.29/build/lib']
...
VALGRIND_FOUND = True
VERSION = '3.29'
WITH_PYBINDGEN = '/home/ayobami/Project1/ns-allinone-3.29/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/ayobami/Project1/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/ayobami/Project1/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
